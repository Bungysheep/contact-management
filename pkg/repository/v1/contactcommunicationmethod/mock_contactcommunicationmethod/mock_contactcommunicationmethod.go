...
func (m *MockIContactCommunicationMethodRepository) DoReadAll(arg0 context.Context) ([]*contactcommunicationmethod.ContactCommunicationMethod, error) {
	m.ctrl.T.Helper()
...
func (mr *MockIContactCommunicationMethodRepositoryMockRecorder) DoReadAll(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DoReadAll", reflect.TypeOf((*MockIContactCommunicationMethodRepository)(nil).DoReadAll), arg0)
}
