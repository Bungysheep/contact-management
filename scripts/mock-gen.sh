...
mockgen -source=./pkg/repository/v1/contactcommunicationmethodfield/contactcommunicationmethodfield.go -destination=./pkg/repository/v1/contactcommunicationmethodfield/mock_contactcommunicationmethodfield/mock_contactcommunicationmethodfield.go
...
mockgen -source=./pkg/service/v1/communicationmethod/communicationmethod.go -destination=./pkg/service/v1/communicationmethod/mock_communicationmethod/mock_communicationmethod.go
...
mockgen -source=./pkg/service/v1/contact/contact.go -destination=./pkg/service/v1/contact/mock_contact/mock_contact.go
mockgen -source=./pkg/service/v1/contactcommunicationmethod/contactcommunicationmethod.go -destination=./pkg/service/v1/contactcommunicationmethod/mock_contactcommunicationmethod/mock_contactcommunicationmethod.go
